...
python tools\optimization_round.py --round-id round-008 --market futures --symbol-count 13 --interval 1m --objective conservative --model-candidates 3 --require-prefilled-data --min-data-rows 1000000 --require-verified-checksum --require-gpu
