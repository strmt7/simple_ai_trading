...
python tools\optimization_round.py --round-id round-004 --symbols ETHUSDT --interval 1s --require-prefilled-data --min-data-rows 70000 --require-verified-checksum
