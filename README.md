...
- Polymarket BTC/ETH/SOL research remains unpromoted. [Round 13](docs/model-research/polymarket/latest/README.md) failed before outcome access: its recorder persisted 1,281,245 source messages over 1,921.322 seconds, far short of the frozen 86,400-second requirement, and recorded four stream gaps. Round 11 remains the latest scored result and failed uncertainty and raw-market-prior gates; its measured maximum drawdown was `12.36399` quote. The separate [BTC live-execution boundary](docs/POLYMARKET_LIVE_EXECUTION.md) does not convert those failed results into authority or a profitability claim.
