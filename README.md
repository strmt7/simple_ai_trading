...
- Non-major symbols such as BNB, DOGE, XRP, low-cap assets, leveraged tokens, and lookalike bases such as ETHW are rejected before data sync, archive ingestion, universe ranking, or optimization.
...
simple-ai-trading archive-sync --top-symbols 3 --quote-asset USDT --interval 1s --cadence daily --require-checksum
...
python tools\optimization_round.py --round-id round-008 --market futures --symbols BTCUSDT,ETHUSDT,SOLUSDT --interval 1m --objective conservative --model-candidates 3 --require-prefilled-data --min-data-rows 1000000 --require-verified-checksum --require-gpu
