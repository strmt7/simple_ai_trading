...
python tools\optimization_round.py --round-id round-008 --market futures --symbol-count 13 --interval 1m --objective conservative --require-prefilled-data --min-data-rows 1000000 --require-verified-checksum --require-gpu
