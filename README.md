...
- Polymarket BTC/ETH/SOL five-minute work is research only. [Round 13](docs/model-research/polymarket/latest/README.md) failed before outcome access: its recorder persisted 1,281,245 source messages over 1,921.322 seconds, far short of the frozen 86,400-second requirement, and recorded four stream gaps. It has no performance metrics or authority. Round 12 was also invalidated before outcome access. Round 11 remains the latest scored result and failed uncertainty and raw-market-prior gates; its measured maximum drawdown was `12.36399` quote. No profitability, ROI, acceptable-drawdown, AI-uplift, paper-policy, or trading claim exists.
