  ...
  private:
    ...
    void refresh_command_combo() {
        ...
        if (page_index_ == 0) {
            ...
            add_group(L"Research", {L"model-lab", L"microstructure-prequential", L"microstructure-promote", L"microstructure-shadow", L"ai-forecast-benchmark", L"ai-review", L"train-suite", L"train", L"prepare", L"tune", L"backtest", L"backtest-chart", L"backtest-panel", L"evaluate", L"objectives", L"signals-benchmark"});
