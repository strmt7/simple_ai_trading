...
inline constexpr CommandSpec kCommands[] = {
    ...
    {L"tape-depth-select", L"usage: simple-ai-trading tape-depth-select [-h] --report REPORT                                            [--output OUTPUT] [--json]", kOptions_tape_depth_select, 3},
    ...
    {L"tick-corpus-audit", L"usage: simple-ai-trading tick-corpus-audit [-h] [--symbols SYMBOLS]                                            [--data-types DATA_TYPES]                                            [--start-date START_DATE]                                            [--end-date END_DATE]                                            [--warehouse WAREHOUSE]                                            [--cache-root CACHE_ROOT]                                            [--memory-limit MEMORY_LIMIT]                                            [--threads THREADS]                                            [--output OUTPUT] [--json]", kOptions_tick_corpus_audit, 10},
