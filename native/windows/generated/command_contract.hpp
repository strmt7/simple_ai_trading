...
inline constexpr CommandSpec kCommands[] = {
    ...
    {L"model-lab", L"usage: simple-ai-trading model-lab [-h] [--output-dir OUTPUT_DIR]                                    [--starting-cash STARTING_CASH]                                    [--objective OBJECTIVE]                                    [--max-symbols MAX_SYMBOLS]                                    [--max-scan MAX_SCAN] [--limit LIMIT]                                    [--market {spot,futures}]                                    [--compute-backend {cpu,cuda,rocm,directml,mps,auto}]                                    [--batch-size BATCH_SIZE]                                    [--score-batch-size SCORE_BATCH_SIZE]", kOptions_model_lab, 10},
    ...
    {L"train-suite", L"usage: simple-ai-trading train-suite [-h] [--input INPUT]                                      [--output-dir OUTPUT_DIR]                                      [--starting-cash STARTING_CASH]                                      [--objective OBJECTIVE]                                      [--max-workers MAX_WORKERS]                                      [--compute-backend {cpu,cuda,rocm,directml,mps,auto}]                                      [--batch-size BATCH_SIZE]", kOptions_train_suite, 7},
