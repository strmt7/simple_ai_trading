...
inline constexpr CommandOptionSpec kOptions_microstructure_train[] = {
    ...
    {L"--trigger-slippage-bps, --stop-slippage-bps", L"trigger_slippage_bps", L"", L"1.0", L"Extra adverse execution cost after a stop/take trigger (default: 1 bps)", L"1", false, true, false},
    {L"--risk-level", L"risk_level", L"conservative, regular, aggressive", L"conservative", L"", L"1", false, true, false},
    {L"--compute-backend", L"compute_backend", L"cpu, cuda, rocm, directml, mps, auto", L"auto", L"", L"1", false, true, false},
    {L"--minimum-promotion-days", L"minimum_promotion_days", L"", L"365", L"", L"1", false, true, false},
...
inline constexpr CommandOptionSpec kOptions_tape_depth_compare[] = {
    {L"--report", L"report", L"", L"", L"prequential report path; repeat for every declared trial", L"1", true, true, true},
    {L"--output", L"output", L"", L"data/tape-depth-comparison.json", L"", L"1", false, true, false},
    {L"--selection-fraction", L"selection_fraction", L"", L"0.67", L"", L"1", false, true, false},
    {L"--json", L"json", L"", L"false", L"", L"0", false, false, false},
};
...
inline constexpr CommandOptionSpec kOptions_tape_depth_prequential[] = {
    ...
    {L"--total-latency-ms", L"total_latency_ms", L"", L"750", L"", L"1", false, true, false},
    {L"--decision-cadence-seconds", L"decision_cadence_seconds", L"", L"20", L"", L"1", false, true, false},
    ...
    {L"--feature-set", L"feature_set", L"core, tape_derived, full", L"full", L"", L"1", false, true, false},
    {L"--compute-backend", L"compute_backend", L"cpu, cuda, rocm, directml, mps, auto", L"auto", L"", L"1", false, true, false},
...
inline constexpr CommandSpec kCommands[] = {
    ...
    {L"tape-depth-compare", L"usage: simple-ai-trading tape-depth-compare [-h] --report REPORT                                             [--output OUTPUT]                                             [--selection-fraction SELECTION_FRACTION]                                             [--json]", kOptions_tape_depth_compare, 4},
