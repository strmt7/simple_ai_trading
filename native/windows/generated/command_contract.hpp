...
inline constexpr CommandOptionSpec kOptions_tick_archive_sync[] = {
    ...
    {L"--start-date", L"start_date", L"", L"", L"inclusive UTC date, YYYY-MM-DD", true, true},
    {L"--end-date", L"end_date", L"", L"", L"inclusive UTC date, YYYY-MM-DD", true, true},
    {L"--warehouse", L"warehouse", L"", L"data/microstructure.duckdb", L"", false, true},
    {L"--cache-root", L"cache_root", L"", L"data/archive-cache", L"", false, true},
    {L"--memory-limit", L"memory_limit", L"", L"8GB", L"", false, true},
    {L"--threads", L"threads", L"", L"8", L"", false, true},
...
inline constexpr CommandSpec kCommands[] = {
    ...
    {L"tick-archive-sync", L"usage: simple-ai-trading tick-archive-sync [-h] [--symbols SYMBOLS]                                            [--data-types DATA_TYPES]                                            --start-date START_DATE --end-date                                            END_DATE [--warehouse WAREHOUSE]                                            [--cache-root CACHE_ROOT]                                            [--memory-limit MEMORY_LIMIT]                                            [--threads THREADS]                                            [--timeout TIMEOUT]                                            [--no-retain-archive] [--json]", kOptions_tick_archive_sync, 11},
