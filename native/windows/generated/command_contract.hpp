...
inline constexpr CommandOptionSpec kOptions_archive_sync[] = {
    ...
    {L"--aggregate-only", L"aggregate_only", L"", L"false", L"for aggTrades, persist derived 1s candles without duplicating raw trades", false, false},
...
inline constexpr CommandOptionSpec kOptions_microstructure_capture[] = {
    {L"--symbols", L"symbols", L"", L"", L"comma-separated supported futures symbols; defaults to configured BTC/ETH/SOL symbols", false, true},
    {L"--seconds", L"seconds", L"", L"60.0", L"", false, true},
    {L"--output-root", L"output_root", L"", L"data/microstructure", L"", false, true},
    {L"--db", L"db", L"", L"data/market_data.sqlite", L"", false, true},
    {L"--timeout", L"timeout", L"", L"10.0", L"", false, true},
    {L"--no-convert", L"convert", L"", L"true", L"capture and validate raw feeds without producing HftBacktest NPZ files", false, false},
    {L"--json", L"json", L"", L"false", L"", false, false},
};
...
inline constexpr CommandOptionSpec kOptions_microstructure_shadow[] = {
    {L"--input", L"input", L"", L"data/microstructure-model.json", L"", false, true},
    {L"--output", L"output", L"", L"", L"", false, true},
    {L"--seconds", L"seconds", L"", L"21660.0", L"public-feed capture duration; promotion requires at least six complete hours", false, true},
    {L"--output-root", L"output_root", L"", L"data/microstructure-shadow/captures", L"", false, true},
    {L"--report", L"report", L"", L"data/microstructure-shadow/report.json", L"", false, true},
    {L"--trades", L"trades", L"", L"data/microstructure-shadow/trades.csv", L"", false, true},
    {L"--db", L"db", L"", L"data/market_data.sqlite", L"", false, true},
    {L"--timeout", L"timeout", L"", L"10.0", L"", false, true},
    {L"--json", L"json", L"", L"false", L"", false, false},
};
...
inline constexpr CommandOptionSpec kOptions_microstructure_train[] = {
    {L"--symbol", L"symbol", L"", L"BTCUSDT", L"", false, true},
    {L"--warehouse", L"warehouse", L"", L"data/microstructure.duckdb", L"", false, true},
    {L"--cache-root", L"cache_root", L"", L"data/archive-cache", L"", false, true},
    {L"--output", L"output", L"", L"data/microstructure-model.json", L"", false, true},
    {L"--horizon-seconds", L"horizon_seconds", L"", L"900", L"", false, true},
    {L"--decision-cadence-seconds", L"decision_cadence_seconds", L"", L"5", L"evaluate one decision candidate every N seconds while retaining 1s features", false, true},
    {L"--total-latency-ms", L"total_latency_ms", L"", L"750", L"", false, true},
    {L"--taker-fee-bps", L"taker_fee_bps", L"", L"5.0", L"", false, true},
    {L"--max-quote-age-ms", L"max_quote_age_ms", L"", L"1000", L"", false, true},
    {L"--reference-order-notional-quote", L"reference_order_notional_quote", L"", L"1000.0", L"reference quote-currency order size used for L1 executability labels", false, true},
    {L"--max-l1-participation", L"max_l1_participation", L"", L"", L"maximum share of displayed top-of-book quantity; defaults by risk profile", false, true},
    {L"--stop-loss-bps", L"stop_loss_bps", L"", L"", L"", false, true},
    {L"--take-profit-bps", L"take_profit_bps", L"", L"", L"", false, true},
    {L"--trigger-slippage-bps, --stop-slippage-bps", L"trigger_slippage_bps", L"", L"1.0", L"Extra adverse execution cost after a stop/take trigger (default: 1 bps)", false, true},
    {L"--risk-level", L"risk_level", L"conservative, regular, aggressive", L"conservative", L"", false, true},
    {L"--compute-backend", L"compute_backend", L"cpu, cuda, rocm, directml, mps, auto", L"auto", L"", false, true},
...
inline constexpr CommandOptionSpec kOptions_status[] = {
    {L"--compact", L"compact", L"", L"false", L"print one secret-free operator status line", false, false},
};
...
inline constexpr CommandOptionSpec kOptions_strategy[] = {
    ...
    {L"--min-position-hold-bars", L"min_position_hold_bars", L"", L"", L"", false, true},
    {L"--flat-signal-exit-grace-bars", L"flat_signal_exit_grace_bars", L"", L"", L"", false, true},
    {L"--max-position-hold-bars", L"max_position_hold_bars", L"", L"", L"", false, true},
...
inline constexpr CommandOptionSpec kOptions_tape_depth_prequential[] = {
    {L"--symbols", L"symbols", L"", L"BTCUSDT,ETHUSDT,SOLUSDT", L"", false, true},
    {L"--warehouse", L"warehouse", L"", L"data/microstructure.duckdb", L"", false, true},
    {L"--cache-root", L"cache_root", L"", L"data/archive-cache", L"", false, true},
    {L"--output-dir", L"output_dir", L"", L"data/tape-depth-prequential", L"", false, true},
    {L"--training-window-days", L"training_window_days", L"", L"730", L"", false, true},
    {L"--tuning-window-days", L"tuning_window_days", L"", L"30", L"", false, true},
    {L"--calibration-window-days", L"calibration_window_days", L"", L"30", L"", false, true},
    {L"--evaluation-window-days", L"evaluation_window_days", L"", L"90", L"", false, true},
    {L"--horizon-seconds", L"horizon_seconds", L"", L"60", L"", false, true},
    {L"--total-latency-ms", L"total_latency_ms", L"", L"750", L"", false, true},
    {L"--decision-cadence-seconds", L"decision_cadence_seconds", L"", L"20", L"", false, true},
    {L"--maximum-depth-age-ms", L"maximum_depth_age_ms", L"", L"60000", L"", false, true},
    {L"--maximum-rows", L"maximum_rows", L"", L"5000000", L"", false, true},
    {L"--maximum-cached-rows", L"maximum_cached_rows", L"", L"15000000", L"", false, true},
    {L"--max-folds", L"max_folds", L"", L"0", L"", false, true},
    {L"--risk-level", L"risk_level", L"conservative, regular, aggressive", L"conservative", L"", false, true},
    {L"--model-profile", L"model_profile", L"regularized, balanced, expressive", L"regularized", L"", false, true},
    {L"--feature-set", L"feature_set", L"core, tape_derived, full", L"full", L"", false, true},
    {L"--compute-backend", L"compute_backend", L"cpu, cuda, rocm, directml, mps, auto", L"auto", L"", false, true},
    {L"--minimum-segment-rows", L"minimum_segment_rows", L"", L"10000", L"", false, true},
    {L"--memory-limit", L"memory_limit", L"", L"8GB", L"", false, true},
    {L"--threads", L"threads", L"", L"8", L"", false, true},
    {L"--plan-only", L"plan_only", L"", L"false", L"", false, false},
    {L"--resume", L"resume", L"", L"false", L"", false, false},
    {L"--json", L"json", L"", L"false", L"", false, false},
};
...
inline constexpr CommandOptionSpec kOptions_tape_depth_train[] = {
    ...
    {L"--warehouse", L"warehouse", L"", L"data/microstructure.duckdb", L"", false, true},
    {L"--cache-root", L"cache_root", L"", L"data/archive-cache", L"", false, true},
    {L"--output", L"output", L"", L"data/tape-depth-model.json", L"", false, true},
    {L"--window-days", L"window_days", L"", L"180", L"", false, true},
    {L"--end-date", L"end_date", L"", L"", L"optional inclusive UTC evaluation date; defaults to latest covered target", false, true},
    {L"--horizon-seconds", L"horizon_seconds", L"", L"60", L"", false, true},
    {L"--total-latency-ms", L"total_latency_ms", L"", L"750", L"", false, true},
    {L"--decision-cadence-seconds", L"decision_cadence_seconds", L"", L"5", L"", false, true},
    {L"--maximum-depth-age-ms", L"maximum_depth_age_ms", L"", L"60000", L"", false, true},
    {L"--risk-level", L"risk_level", L"conservative, regular, aggressive", L"conservative", L"", false, true},
    {L"--model-profile", L"model_profile", L"regularized, balanced, expressive", L"regularized", L"", false, true},
    {L"--feature-set", L"feature_set", L"core, tape_derived, full", L"full", L"", false, true},
    {L"--compute-backend", L"compute_backend", L"cpu, cuda, rocm, directml, mps, auto", L"auto", L"", false, true},
    {L"--minimum-segment-rows", L"minimum_segment_rows", L"", L"2000", L"", false, true},
    {L"--maximum-rows", L"maximum_rows", L"", L"5000000", L"", false, true},
    {L"--memory-limit", L"memory_limit", L"", L"8GB", L"", false, true},
    {L"--threads", L"threads", L"", L"8", L"", false, true},
    {L"--json", L"json", L"", L"false", L"", false, false},
...
inline constexpr CommandOptionSpec kOptions_tick_archive_sync[] = {
    {L"--symbols", L"symbols", L"", L"", L"comma-separated BTC/ETH/SOL futures symbols; defaults to runtime symbols", false, true},
    {L"--data-types", L"data_types", L"", L"bookTicker,trades", L"comma-separated official products: bookTicker,trades,bookDepth", false, true},
    {L"--start-date", L"start_date", L"", L"", L"inclusive UTC date, YYYY-MM-DD", false, true},
    {L"--end-date", L"end_date", L"", L"", L"inclusive UTC date, YYYY-MM-DD", false, true},
    {L"--full-history", L"full_history", L"", L"false", L"discover and select every official file independently for each symbol/data type", false, false},
    {L"--available-only", L"available_only", L"", L"false", L"record but do not fail on unavailable symbol/data-type dates", false, false},
    {L"--plan-only", L"plan_only", L"", L"false", L"report official file coverage and compressed bytes without downloading", false, false},
    {L"--plan-output", L"plan_output", L"", L"", L"optional atomic JSON path for the compact official coverage plan", false, true},
    {L"--max-planned-gb", L"max_planned_gb", L"", L"500.0", L"block downloads above this official compressed-byte plan; use 0 to disable", false, true},
    {L"--warehouse", L"warehouse", L"", L"data/microstructure.duckdb", L"", false, true},
    {L"--cache-root", L"cache_root", L"", L"data/archive-cache", L"", false, true},
    {L"--memory-limit", L"memory_limit", L"", L"8GB", L"", false, true},
    {L"--threads", L"threads", L"", L"8", L"", false, true},
    {L"--timeout", L"timeout", L"", L"240.0", L"", false, true},
    {L"--no-retain-archive", L"no_retain_archive", L"", L"false", L"", false, false},
    {L"--json", L"json", L"", L"false", L"", false, false},
};
