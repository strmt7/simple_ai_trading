...
EXPECTED_REGISTRY_HASH = "9646724dc11354e2779405bbede7e4ae1deb3f759e6c828d38c0f79c32161571"
...
def test_registry_prioritizes_the_accepted_scoped_increment() -> None:
    ...
    assert [row["priority_rank"] for row in hypotheses] == list(range(1, 24))
    lead = next(
        row
    ...
    assert registry["accepted_edge_count"] == 11
