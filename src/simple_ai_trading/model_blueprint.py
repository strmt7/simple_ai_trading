...
MODEL_FAMILIES: tuple[ModelFamilyBlueprint, ...] = (
    ...
    ModelFamilyBlueprint(
        family="observe_only_meta_label",
        role="Learn whether accepted primary signals should be taken, downsized, or skipped.",
        status="implemented_evidence",
        ...
        risk_levels=RISK_LEVELS,
        execution_authority="observe_only_until_promoted_by_tests",
        validation_gates=(
            "precision target by objective",
            "trade-count sufficiency",
            "out-of-sample replay",
            "fail-closed unavailable-policy warning",
        ),
        sources=(
