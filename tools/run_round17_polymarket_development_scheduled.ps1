...
$runner = Join-Path $repositoryRoot "tools\run_round17_polymarket_development.py"
$dataRoot = Join-Path $repositoryRoot "data"
$output = Join-Path $dataRoot "polymarket-round17-development-v1.json"
$log = Join-Path $dataRoot "polymarket-round17-development-v1.log"
$done = Join-Path $dataRoot "polymarket-round17-development-v1.done"
...
if (
    ...
    throw "Round 17 scheduled runtime is unavailable."
}
...
$arguments = @(
    ...
    "--economic-contract", "docs/model-research/polymarket/round-017-btc-5m-economic-pretest-v1.json",
    "--output", $output,
