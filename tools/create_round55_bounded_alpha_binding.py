"""Bind the committed Round 55 implementation and external evidence inputs."""
...
PATHS = (
    ...
    "tools/create_round55_bounded_alpha_binding.py",
    "tools/run_round55_ai_factor_research.py",
    "tools/run_round55_bounded_alpha.py",
)
CACHE_FILES = (
    "features.npy",
...
def _git(*arguments: str) -> str:
    try:
        ...
        raise ValueError("Round 55 binding Git command failed") from exc
...
def run(arguments: argparse.Namespace) -> int:
    design = _read_object(arguments.design.resolve(), "Round 55 design")
    ...
    payload: dict[str, object] = {
        ...
        "command": (
            ".venv311\\Scripts\\python.exe tools\\run_round55_bounded_alpha.py "
            "--binding docs\\model-research\\action-value\\round-055-bounded-alpha-execution-binding.json "
            "--source-certificate <external-certificate.json> "
            "--derived-cache <round45-derived-cache> --ai-report <round55-ai-report.json> "
            "--ai-ledger <round55-factor-program-ledger.json> "
