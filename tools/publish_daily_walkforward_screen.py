...
def _progress_svg(progress: Sequence[Mapping[str, object]]) -> str:
    ...
    lines = [
        ...
        '<desc id="desc">Simulated-trade means, overlapping-forecast diagnostics, and rounds with no simulated-trade series use distinct markers. Round fifteen produced no evaluation trades.</desc>',
        '<rect width="100%" height="100%" fill="#ffffff"/>',
        ...
        '<text x="56" y="84" font-family="Segoe UI, Arial, sans-serif" font-size="15" fill="#52606d">Distinct markers prevent diagnostics or abstention from being presented as a simulated-trade mean.</text>',
        '<circle cx="900" cy="55" r="7" fill="#b42318"/><text x="917" y="60" font-family="Segoe UI, Arial, sans-serif" font-size="12" fill="#52606d">simulated-trade mean</text>',
        '<rect x="1052" y="48" width="14" height="14" fill="#ffffff" stroke="#60717f" stroke-width="2" transform="rotate(45 1059 55)"/><text x="1076" y="60" font-family="Segoe UI, Arial, sans-serif" font-size="12" fill="#52606d">no simulated-trade series</text>',
