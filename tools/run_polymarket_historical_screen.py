...
DEFAULT_DATABASE = ROOT / "data" / "polymarket-round15-historical-screen-v1.duckdb"
...
def _committed_source_head() -> str:
    source_paths = (
        ...
        "tools/run_polymarket_historical_screen.py",
    )
...
def main(
    *,
    ...
    default_microstructure: Path = DEFAULT_MICROSTRUCTURE,
) -> int:
    parser = argparse.ArgumentParser(
        description="Run a frozen target-separated Polymarket BTC historical screen."
    )
    parser.add_argument(
        "phase",
        choices=(
